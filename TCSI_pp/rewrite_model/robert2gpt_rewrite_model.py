...
roberta2gpt_model = EncoderDecoderModel.from_encoder_decoder_pretrained("hfl/chinese-roberta-wwm-ext", "shibing624/gpt2-dialogbot-base-chinese")
tokens = ["[SEP]"]
...
savepath=f"./result/roberta2bert_rewrite_epoch{num_epoch}.ckpt" #save model
save_rewrite_path=f'./result/roberta2bert_rewrite_epoch{num_epoch}.json' #save rewrite result
lr=3e-4
