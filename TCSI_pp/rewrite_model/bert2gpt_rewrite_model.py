...
bert2gpt_model = EncoderDecoderModel.from_encoder_decoder_pretrained("bert-base-chinese", "shibing624/gpt2-dialogbot-base-chinese")
bert2gpt_model=bert2gpt_model.to('cuda')
...
savepath=f"./result/bert2gpt_rewrite_epoch{num_epoch}.ckpt" #save model
save_rewrite_path=f'./result/bert2gpt_rewrite_epoch{num_epoch}.json' #save rewrite result
